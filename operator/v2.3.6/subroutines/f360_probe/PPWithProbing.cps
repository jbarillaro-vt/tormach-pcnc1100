...
propertyDefinitions = {
  ...
  probeFastSpeed: {title: "Fast probing speed (inch/min)", description: "Fast probing speed (inch/min)", type:"number"},
  probeSlowSpeed: {title: "Slow probing speed (inch/min)", description: "Slow probing speed (inch/min)", type:"number"},
  probeSlowDistance: {title: "Slow probe distance (inch)", description: "Slow probe distance (inch)", type:"number"}
